...
By definition an observational processes is only a conceptual
abstraction. In order for it to take form as an explicit mathematical
object we need to define exactly how observations are *realized* from an observational process. This process, however, is subtle and results not in constant outcomes but rather a *variation* of possible outcomes within an *observation space*, Y [@betancourt2019].
